...
for i = length(wattSamples):-1:1
    ...
    oxygenRequirement = molToMl(vLactateOut * 3);
    lactateFraction = oxygenRequirement./wattSampleVO2(i);
    vO2results(i,:) = wattSampleVO2(i)./((1-lactateFraction) + lactateEfficency .* lactateFraction);
end
